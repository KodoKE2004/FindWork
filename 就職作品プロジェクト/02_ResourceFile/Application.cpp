...
void Application::ApplyWindowConfig(uint32_t width, uint32_t height, bool fullscreen)
{
    m_Width = std::max<uint32_t>(width, 320);
    m_Height = std::max<uint32_t>(height, 240);
